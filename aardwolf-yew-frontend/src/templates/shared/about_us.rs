    ...
    html! {
        <>
            <div class="column is-mobile">
                ...
                <p>{t!("Each server hosts its own community of users who are posting, sharing pictures, links, etc. They are replying and liking each other's posts, and re-sharing the ones they like best.")}</p><br />
